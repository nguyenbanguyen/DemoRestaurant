...
namespace DemoRestaurant.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {    
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Xác nhận tài khoản trên Demo Restaurant", "Vui lòng xác nhận tài khoản được đăng ký trên trang demo restaurant : <a href=\"" + callbackUrl + "\">Click tại đây.</a>");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null || !(await UserManager.IsEmailConfirmedAsync(user.Id)))
                {
                    ...
                    return View("ForgotPasswordConfirmation","Không tìm thấy mail đã nhập, vui lòng kiểm tra lại thông tin");
                }
                ...
                // Send an email with this link
                 ...
                 await UserManager.SendEmailAsync(user.Id, "Lấy lại mật khẩu", "Vui lòng thiết lập lại mật khẩu : <a href=\"" + callbackUrl + "\">Click tại đây</a>");
        ...
        [AllowAnonymous]
        public ActionResult ForgotPasswordConfirmation( string Message)
        {
            if (Message == null || Message == "") Message = "Vui lòng kiểm tra mail để thiết lập lại mật khẩu";
